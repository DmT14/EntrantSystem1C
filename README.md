# EntrantSystem1С — система учёта абитуриентов вуза на платформе «1С:Предприятие 8»
## Описание проекта
...
## Исходные файлы
Файл `1Cv8.dt` является выгрузкой информационной базы. Кроме того, для демонстрации работы системы база данных была наполнена в том числе и документами, которые расположены в папке `documents` (эту папку необходимо поместить в корень диска `C` и переименовать на `Сканы`). Исходный код модулей системы приведён в файле `source.pdf`.
